/**
 * محرك التفقيط المالي العربي الشامل والمتوافق محاسبياً (Server-side)
 * Comprehensive Arabic Financial Tafqeet Engine
 * يدعم المعايير المحاسبية واللغوية، الأعداد الكبيرة، الكسور النقدية بدقة، وقواميس العملات الإقليمية
 */
...
function tafqeet(amount, currency = 'ر.ي') {
  ...
  // حماية من أخطاء الفاصلة العائمة (IEEE 754 float precision)
